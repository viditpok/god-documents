...
class Trainer:
    ...
    def run_wandb_training_loop(self, num_epochs: int) -> None:
        ...
        wandb.login(key="636ef166bb97949d28292dba7f56de14695297b4")
        wandb.init(project="dlrecog", entity="viditdpokharna")
        ...
        for epoch_idx in range(num_epochs):
            ...
            print(
                f"Epoch:{epoch_idx + 1} Train Loss:{train_loss:.4f} Val Loss: {val_loss:.4f} Train Accuracy: {train_acc:.4f} Validation Accuracy: {val_acc:.4f}"
            )
