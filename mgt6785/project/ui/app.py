...
from ui.theming import NAVY_DARK, configure_plotly, inject_global_styles  # noqa: E402
...
def strategy_docs_page() -> None:
    ...
    st.write(
        """
        **MacroTone** integrates **Macroeconomic Regime Detection** with **Natural Language Processing (NLP)** to predict 
    ...
    st.divider()
    st.caption("Developed by Macrotone Team")
